...
struct SensoryRegulationView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 24) {
                ...
                ZStack {
                    Circle()
                        ...
                        .animation(Animation.easeInOut(duration: 3).repeatForever(autoreverses: true), value: animateBreath)
                    Text("Breathe")
                        .font(.headline)
                }
                .onAppear {
        ...
        .background(colorSensitive ? Color(.systemGray6) : Color(.systemGroupedBackground))
